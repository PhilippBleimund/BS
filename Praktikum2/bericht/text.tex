...
In \cref{fig:best_algo} wurde zusätzlich zur maximalen Größe einer einzelnen Allozierung auch der verfügbare Speicher variiert. Es ist zu erkennen, das best-fit in den meisten Fällen der beste Algorithmus ist. Best-fit ist in 10705 Kombinationen der beste Algorithmus. Am schlechtesten schneidet worst-fit mit einem Wert von 959 ab. First-fit und next-fit schneiden ähnlich mit 1919 und 1466 Kombinationen etwas besser als worst-fit ab. Die weiße Fläche stellt alle Kombinationen dar, in denen es mehr als zwei beste Algorithmen gibt und dominiert mit 24552 Kombinationen.
